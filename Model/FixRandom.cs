...
namespace Common
{
    ...
    public class FixRandom
    {
        ...
        /// <summary>
        /// Returns a Fix64 between a min value [inclusive] and a max value [inclusive].
        /// </summary>
        ...
        /// <summary>
        /// Returns a Fix64 between 0.0 [inclusive] and 1.0 [inclusive].
        /// </summary>
        public Fix64 NextFP()
        {
        ...
        /// <summary>
        /// Returns a random FixVector3 representing a point inside a sphere with radius 1.
        /// </summary>
